...
import AudioControl from "../components/devices/AudioControl";  // ✅ Replace
...
const Boardroom = () => {
  ...
  return (
    <div className="h-full overflow-hidden bg-gradient-to-br from-white to-blue-200">
      {/* Main Controls Grid - NO outer card wrappers */}
      <div className="h-full overflow-hidden p-4 lg:p-6 touchPanel:p-8">
        <div className="h-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6 touchPanel:gap-8 max-w-7xl mx-auto">
          ...
          {/* Speaker Control - SINGLE CARD (height from Boardroom) */}
          <div className="h-[75vh] lg:h-[80vh] touchPanel:h-[84vh] flex flex-col">
            <AudioControl room="boardroom" />
          </div>

          {/* Source Selection - SINGLE CARD (height from Boardroom) */}
          <div className="h-[75vh] lg:h-[80vh] touchPanel:h-[84vh] flex flex-col">
            <SourceSelection room="boardroom" />
          </div>

          {/* Room Arrangements - SINGLE CARD (height from Boardroom) */}
          <div className="h-[75vh] lg:h-[80vh] touchPanel:h-[84vh] flex flex-col">
